import rospy
from object_detection_msgs.msg import ObjectDetectionInfo  # Replace with your actual message type
...
#         rospy.Subscriber('/object_detector/detection_info', ObjectDetectionInfo, self.callback)
...
if __name__ == '__main__':
    ...
    #rospy.Subscriber("/object_detector/detection_info", ObjectDetectionInfo, object_detection_callback)
    print("Step 3 done")
    # node = DetectionSaver()
